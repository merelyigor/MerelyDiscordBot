...
- Коміт і push у цьому репозиторії агент робить сам (рішення власника 2026-09-18): за конвенцією повідомлення цього репозиторію, стейджачи лише свої шляхи, після гейта з кодом 0 і з подальшим зеленим CI, якщо він є. Force-push, rebase, теги й будь-яке переписування історії — лише за разовим явним дозволом; дозвіл не переноситься на наступну дію.
